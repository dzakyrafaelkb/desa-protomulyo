        ...
        <form action="<?php echo e(route('login.proses')); ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="username" class="form-control border-start-0 bg-light" placeholder="Masukkan username" value="<?php echo e(old('username')); ?>" required>
                </div>
            </div>
            <div class="mb-4">
            ...
            <div class="text-center">
                <a href="<?php echo e(route('home')); ?>" class="text-muted small text-decoration-none">
...
<?php /**PATH C:\Users\ZAKY\Documents\testing\resources\views/auth/login.blade.php ENDPATH**/ ?>
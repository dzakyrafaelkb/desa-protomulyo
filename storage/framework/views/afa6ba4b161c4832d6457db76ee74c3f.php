...
<div class="container-fluid px-4 py-5">
    ...
    <div class="org-wrap">
        ...
        <?php if($level1->count()): ?>
        <div class="org-row">
            <?php $__currentLoopData = $level1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="org-col">
                <div class="org-card card-l1">
                    <div class="foto-wrap">
                        <?php if($p->foto): ?>
                            <img src="<?php echo e(Storage::url($p->foto)); ?>" alt="<?php echo e($p->nama); ?>">
                        <?php else: ?>
                            <i class="bi bi-person-fill text-white" style="font-size:48px;"></i>
                        <?php endif; ?>
                    </div>
                    <h6><?php echo e($p->nama); ?></h6>
                    <small><?php echo e($p->jabatan); ?></small>
                </div>
            </div>
        ...
        <?php if($level2->count()): ?>
        <div class="org-row">
            <?php $__currentLoopData = $level2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="org-col">
        ...
        <?php if($level3->count() || $level4->count()): ?>
        <div class="org-row">
            <?php $__currentLoopData = $level3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="org-col">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php $__currentLoopData = $level4; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="org-col">
        ...
        <?php if($levelLain->count()): ?>
        <div class="line-v"></div>
        <div class="anggota-label">Staf & Anggota</div>
        <div class="org-row">
            <?php $__currentLoopData = $levelLain; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="org-col">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ZAKY\Documents\testing\resources\views/public/profil.blade.php ENDPATH**/ ?>
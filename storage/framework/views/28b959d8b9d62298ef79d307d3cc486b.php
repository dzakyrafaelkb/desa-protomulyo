...
<head>
    ...
    <title><?php echo $__env->yieldContent('title','Admin'); ?> - Desa Protomulyo</title>
...
<div class="sidebar">
    ...
    <a href="<?php echo e(route('admin.penduduk.index')); ?>" class="<?php echo e(request()->routeIs('admin.penduduk*') ? 'active' : ''); ?>">
        <i class="bi bi-people me-2"></i>Data Penduduk
    </a>
    <a href="<?php echo e(route('admin.pengaduan.index')); ?>" class="<?php echo e(request()->routeIs('admin.pengaduan*') ? 'active' : ''); ?> d-flex justify-content-between">
        <span><i class="bi bi-chat-left-text me-2 text-warning"></i>Pengaduan</span>
        <?php $pendingCount = \App\Models\Pengaduan::where('status','Pending')->count(); ?>
        <?php if($pendingCount > 0): ?>
            <span class="badge bg-danger rounded-pill" style="font-size:10px;"><?php echo e($pendingCount); ?></span>
        <?php endif; ?>
    </a>
    ...
    <a href="<?php echo e(route('admin.perangkat.index')); ?>" class="<?php echo e(request()->routeIs('admin.perangkat*') ? 'active' : ''); ?>">
        <i class="bi bi-person-badge me-2"></i>Perangkat Desa
    </a>
    <a href="<?php echo e(route('admin.dokumen.index')); ?>" class="<?php echo e(request()->routeIs('admin.dokumen*') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('home')); ?>" target="_blank"><i class="bi bi-globe me-2"></i>Lihat Website</a>
...
<div class="main-content">
    <div class="topbar">
        <h5 class="fw-bold mb-0"><?php echo $__env->yieldContent('page-title','Dashboard'); ?></h5>
        <div class="d-flex align-items-center gap-3">
            <small class="text-muted"><?php echo e(now()->isoFormat('D MMMM Y')); ?></small>
            <div class="d-flex align-items-center gap-2">
                ...
                <span class="fw-semibold" style="font-size:14px;"><?php echo e(session('admin')['nama_lengkap'] ?? 'Admin'); ?></span>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\ZAKY\Documents\testing\resources\views/layouts/admin.blade.php ENDPATH**/ ?>
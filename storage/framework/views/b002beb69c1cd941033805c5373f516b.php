...
<nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top py-3">
    <div class="container">
        <a class="navbar-brand text-success d-flex align-items-center" href="<?php echo e(route('home')); ?>">
            ...
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu border-0 shadow-sm mt-2">
                        <li><a class="dropdown-item" href="<?php echo e(route('profil')); ?>">Visi Misi & Perangkat</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('sejarah')); ?>">Sejarah Desa</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('galeri')); ?>"><i class="bi bi-images me-2 text-success"></i>Galeri Desa</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle px-3" href="#" data-bs-toggle="dropdown">Layanan</a>
                    <ul class="dropdown-menu border-0 shadow-sm mt-2">
                        <li><a class="dropdown-item" href="<?php echo e(route('cek-nik')); ?>"><i class="bi bi-person-vcard me-2"></i>Cek NIK</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('layanan')); ?>"><i class="bi bi-file-earmark-text me-2"></i>Unduh Formulir</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item text-success fw-bold" href="<?php echo e(route('pengaduan')); ?>"><i class="bi bi-chat-dots-fill me-2"></i>Pengaduan Warga</a></li>
                    </ul>
                </li>
                <li class="nav-item"><a class="nav-link px-3 <?php echo e(request()->routeIs('berita*') ? 'active' : ''); ?>" href="<?php echo e(route('berita')); ?>">Berita</a></li>
                <li class="nav-item ms-lg-3"><a class="btn btn-outline-success rounded-pill px-4" href="<?php echo e(route('login')); ?>">Login Admin</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<footer class="bg-dark text-white py-5 mt-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                ...
                <ul class="list-unstyled">
                    <li class="mb-1"><a href="<?php echo e(route('profil')); ?>" class="text-white-50 text-decoration-none small"><i class="bi bi-chevron-right me-1 text-success"></i>Profil Desa</a></li>
                    <li class="mb-1"><a href="<?php echo e(route('berita')); ?>" class="text-white-50 text-decoration-none small"><i class="bi bi-chevron-right me-1 text-success"></i>Berita</a></li>
                    <li class="mb-1"><a href="<?php echo e(route('layanan')); ?>" class="text-white-50 text-decoration-none small"><i class="bi bi-chevron-right me-1 text-success"></i>Layanan</a></li>
                    <li class="mb-1"><a href="<?php echo e(route('pengaduan')); ?>" class="text-white-50 text-decoration-none small"><i class="bi bi-chevron-right me-1 text-success"></i>Pengaduan</a></li>
                </ul>
            </div>
            <div class="col-md-4 mb-4">
        ...
        <p class="text-center text-white-50 small mb-0">© <?php echo e(date('Y')); ?> Desa Protomulyo. Dibuat dengan sepenuh hati</p>
    </div>
</footer>
...
<?php /**PATH C:\Users\ZAKY\Documents\testing\resources\views/layouts/app.blade.php ENDPATH**/ ?>